...
// in mobile_app/test/integration/auth_flow_test.dart.
...
import 'package:mobile_app/features/auth/data/services/productor_service.dart'
    as _i5;
import 'package:mobile_app/features/auth/domain/models/productor.dart' as _i6;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockProductorService extends _i1.Mock implements _i5.ProductorService {
  MockProductorService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<void> createProductor(_i6.Productor? productor) =>
      (super.noSuchMethod(
            Invocation.method(#createProductor, [productor]),
            returnValue: _i4.Future<void>.value(),
            returnValueForMissingStub: _i4.Future<void>.value(),
          )
          as _i4.Future<void>);
